...
public class SessionHandler {
     ...
     * @param firstName
     */
    public void loginUser(String email_id, String firstName) {
        mEditor.putString(KEY_EMAIL_ID, email_id);
    ...
    public User getUserDetails() {
        ...
        User user = new User();
        user.setEmailid(mPreferences.getString(KEY_EMAIL_ID, KEY_EMPTY));
